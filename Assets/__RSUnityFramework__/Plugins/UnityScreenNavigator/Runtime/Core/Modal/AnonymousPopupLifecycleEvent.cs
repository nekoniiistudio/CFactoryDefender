...
namespace UnityScreenNavigator.Runtime.Core.Modal
{
    public sealed class AnonymousPopupLifecycleEvent : IPopupLifecycleEvent
    {
...
#else
        public AnonymousPopupLifecycleEvent(Func<IEnumerator> initialize = null,
...
#else
        IEnumerator IPopupLifecycleEvent.Initialize()
        {
...
#else
        IEnumerator IPopupLifecycleEvent.WillPushEnter()
        {
        ...
        void IPopupLifecycleEvent.DidPushEnter()
        {
...
#else
        IEnumerator IPopupLifecycleEvent.WillPushExit()
        {
        ...
        void IPopupLifecycleEvent.DidPushExit()
        {
...
#else
        IEnumerator IPopupLifecycleEvent.WillPopEnter()
        {
        ...
        void IPopupLifecycleEvent.DidPopEnter()
        {
...
#else
        IEnumerator IPopupLifecycleEvent.WillPopExit()
        {
        ...
        void IPopupLifecycleEvent.DidPopExit()
        {
            OnDidPopExit?.Invoke();
        }
...
#else
        IEnumerator IPopupLifecycleEvent.Cleanup()
        {
