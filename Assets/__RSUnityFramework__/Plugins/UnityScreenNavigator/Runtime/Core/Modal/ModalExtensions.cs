...
namespace UnityScreenNavigator.Runtime.Core.Modal
{
    public static class ModalExtensions
    {
        ...
        public static void AddLifecycleEvent(this Modal self, Func<Task> initialize = null,
            ...
            int priority = 0)
#else
        public static void AddLifecycleEvent(this Popup self, Func<IEnumerator> initialize = null,
...
#endif
        {
            var lifecycleEvent = new AnonymousPopupLifecycleEvent(initialize, onWillPushEnter, onDidPushEnter,
