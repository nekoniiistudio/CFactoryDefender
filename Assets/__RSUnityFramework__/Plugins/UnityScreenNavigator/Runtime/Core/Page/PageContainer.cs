...
namespace UnityScreenNavigator.Runtime.Core.Page
{
    ...
    {   
            ...
            PageFactory pageFactory)
        {
            ...
            Debug.Log("Resolve PageContainer");
        }
        ...
        /// <returns></returns>
        public AsyncProcessHandle Push<T>(
            string resourceKey,
            bool playAnimation,
            bool stack = true,
            string pageId = null,
        ...
        public AsyncProcessHandle PopAsBack(bool playAnimation)
        {
            return CoroutineManager.Instance.Run(PopRoutine(playAnimation, 1));
        }
        ...
        private IEnumerator PushRoutine<T>(
            string resourceKey,
            bool playAnimation,
            bool stack = true,
            Action<(string pageId, Page page)> onLoad = null,
        ...
        )  where T : Page    
        {
            ...
            _pages.TryAdd(context.EnterPageId, context.EnterPage);
        ...
        private IEnumerator LoadPageAndBind<T>(
            string resourceKey,
            bool loadAsync,
            Action<Page, AssetLoadHandle<GameObject>, string> onLoaded
        ) where T : Page
        {
